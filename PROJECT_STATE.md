...
**Снимок:** 2026-07-26 · UI_BUILD **58** / schema 11 · contextVersion **1**. Roadmap — нумерованный аккордеон со статусом **Проверил**. **Фокус: стабилизация.** Настройки и `/logs`: **Проверил 26.07.2026**. Следом: git-контрольная точка.
...
1. Стабильная контрольная точка релиза (git).
2. Потом: чеки / merchantId / Assistant / Валет.
